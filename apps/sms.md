Legacy carrier communication [should be avoided](https://grapheneos.org/faq#cellular-tracking). You should instead use secure messaging apps with the Signal protocol implemented properly when possible.
